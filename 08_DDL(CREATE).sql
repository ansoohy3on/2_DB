...
-- ORA-01400: NULL을 ("ASH"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
CREATE TABLE USER_USED_UK(
    USER_NO NUMBER,
    -- USER_ID VARCHAR2(20) UNIQUE, -- 컬럼 레벨 제약 조건 설정 (제약 조건명 미지정)
    ...
    -- 테이블 레벨 제약 조건 설정 부분
    -- UNIQUE(USER_ID) -- 테이블 레벨 제약 조건 설정(제약 조건명 미지정)
...
-- ORA-00001: 무결성 제약 조건(ASH.USER_ID_U)에 위배됩니다
            --> UNIQUE
...
-- ORA-00001: 무결성 제약 조건(ASH.USER_ID_NAME_U)에 위배됩니다
...
--> 기본 키 중복으로 오류
-- ORA-00001: 무결성 제약 조건(ASH.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES(NULL, 'user03', 'pass03', '유관순', '여', '010-9999-3131', 'yoo123@kh.or.kr');
--> 기본 키가 NULL이므로 오류
-- ORA-01400: NULL을 ("ASH"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
...
-- 회원 번호와 아이디 둘 다 중복되었을 때만 제약 조건 위배 에러 발생
-- ORA-00001: 무결성 제약 조건(ASH.PK_USERNO_USERID)에 위배됩니다
...
--> 복합 키여도 PK이므로 NULL은 절대 안 됨!
-- ORA-01400: NULL을 ("ASH"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다

--------------------------------------------------------------------------------

-- 4. FOREIGN KEY(외부 키 / 외래 키) 제약 조건
...
-- ORA-02291: 무결성 제약조건(ASH.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
                --> 참조 무결성 위배
...
WHERE GRADE_CODE = 10;
-- ORA-02292: 무결성 제약조건(ASH.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
-- CHECK (컬럼명 비교연산자 비교값)
-- 주의 : 비교값은 리터럴만 사용할 수 있음, 변하는 값이나 함수 사용 못 함
...
-- ORA-02290: 체크 제약조건(ASH.GENDER_CHECK)이 위배되었습니다
...
-- * 수업 시간에 활용하던 테이블에는 FK 제약조건 없는 상태이므로 추가!!
